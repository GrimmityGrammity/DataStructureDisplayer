...
public class TreeEditorGUI extends JFrame implements ActionListener, KeyListener {
	...
	private JMenuItem		newRBTreeItem = new JMenuItem("..New RB Tree");
	...
	private void initialize() {
		...
		newRBTreeItem.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		//FILE MENU ITEMS
			...
			editor.newTrie();
		else if (e.getSource() == newRBTreeItem)
			editor.newRBTree();
